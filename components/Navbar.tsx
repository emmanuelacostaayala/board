...
const Navbar = () => {
    ...
    return (
        <>
            ...
            {/* Mobile Sidebar Menu */}
            <div className={`fixed top-0 left-0 h-[100dvh] w-80 max-w-[85vw] bg-white shadow-2xl z-50 lg:hidden transform transition-transform duration-300 ease-in-out ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full'}`}>
